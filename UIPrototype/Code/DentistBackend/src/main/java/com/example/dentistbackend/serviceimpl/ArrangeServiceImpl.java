...
public class ArrangeServiceImpl implements ArrangeService{
    ...
    @Override
    public List<Arrangement> getDoctorArrangement(String name)
    {
        return ArrangeDao.getDoctorArrangement(name);
    }
    ...
    @Override
    public Arrangement AddNewArrangement(String weekday, String startTime, String doctorName,
                                         int orderNum)
    {
        return ArrangeDao.AddNewArrangement(weekday, startTime, doctorName, orderNum);
    }
}
